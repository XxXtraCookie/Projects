// Get your shorts on - this is an array workout!
    ...
    // STAYS COMMENTED BECAUSE THESE CONSTS USE WIKI PAGE

    // const category = document.querySelector('.mw-category');
    // const links = Array.from(category.querySelectorAll('a')); // We use Array.from() or spread because NodeList is array-like object, but not an actual array
    // const de = links
    //   .map(function(link) {
